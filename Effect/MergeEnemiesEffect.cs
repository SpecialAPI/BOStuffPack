...
namespace BOStuffPack.Effect
{
        ...
        public override bool PerformEffect(CombatStats stats, IUnit caster, TargetSlotInfo[] targets, bool areTargetSlots, int entryVariable, out int exitAmount)
        {
            ...
            foreach (var kvp in mergeData)
            {
                ...
                foreach (var e in targettedEnemies)
                {
                    ...
                    extraabilities += e.SimpleGetStoredValue(LocalStoredValues.MergedCount._UnitStoreDataID) + 1;
                }
    ...
    public class TrySpawnMergedEnemyAction(EnemySO enemy, bool givesExperience, int maxHealth, int currentHealth, int extraAbilities) : CombatAction
    {
        public override IEnumerator Execute(CombatStats stats)
        {
            ...
            en.SimpleSetStoredValue(LocalStoredValues.MergedCount._UnitStoreDataID, extraAbilities);
